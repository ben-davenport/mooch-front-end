...
class FullAbode extends Component{
    ...
    //     const numNights = 1;
    //     const amount = this.state.toold.pricePerNight * numNights;
    ...
    async componentDidMount(){
        ...
        // console.log(abodeId);
        const url = `${window.apiHost}/tool/${toolId}`
    ...
    render(){
        ...
        if(this.props.auth.token){
            ...
            button = <button  className="btn">Reserve A Tool</button>
        }else{
            button = <button onClick={()=>{this.props.history.push('/login')}}className="btn">Please login to Borrow</button>
        }
            ...
            <div className="row fullAbode">
                ...
                <div className="col s8 location-details offset-s2">
                    ...
                    <div className="col s4 right-details">
                        ...
                        <div className="price-per-day">$ {tool.pricePerNight} <span>per day</span></div>
